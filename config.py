...
faculties = ['ИМиКН','Гум.науки','Право','Экономика','Менеджемент'] # факультеты нижегородской вышки
...
switcher = {
	...
	'Менеджемент': ["17М1","17М2","17М3","17М4","16М1","16М2","16М3","16М4","15М1","15М2","15М3","15М4"]
}